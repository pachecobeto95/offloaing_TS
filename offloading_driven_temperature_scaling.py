...
if (__name__ == "__main__"):
	...
	# This argument defines the input resize dimension.
	parser.add_argument('--input_resize', type=int, default=config.input_resize, 
		help='Input Dimension. Default: %s'%(config.input_resize))
